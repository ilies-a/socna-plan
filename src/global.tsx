import { JoinedWalls, Line, WallNode, PlanElement, Position, Rectangle } from "./entities";
import { v4 } from "uuid";
...
const node1 = new WallNode(v4(), new Position(10, 10), []);
const node2 = new WallNode(v4(), new Position(100, 100), []);
const node3 = new WallNode(v4(), new Position(200, 150), []);
const node4 = new WallNode(v4(), new Position(100, 300), []);
const node5 = new WallNode(v4(), new Position(50, 400), []);
const node6 = new WallNode(v4(), new Position(200, 350), []);
const node7 = new WallNode(v4(), new Position(250, 150), []);
const node8 = new WallNode(v4(), new Position(400, 50), []);
